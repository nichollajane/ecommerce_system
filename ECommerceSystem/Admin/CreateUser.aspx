<%@ Page Title="User List" Language="C#" MasterPageFile="~/Administration.Master" AutoEventWireup="true" CodeBehind="CreateUser.aspx.cs" Inherits="ECommerceSystem.Admin.CreateUser" %>
            ...
            <table class="w-100">
                <tr>
                    ...
                    <td class="auto-style5">
                        <asp:TextBox ID="Fullname" runat="server" Width="200px" CssClass="form-control"></asp:TextBox>
                        <br />
                ...
                <tr>
                    ...
                    <td class="auto-style2">
                        ...
                        <br />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator30" runat="server" ControlToValidate="Street" ErrorMessage="Street is Required!" ForeColor="Red"></asp:RequiredFieldValidator>
                        <br />
                    </td>
                    <td class="auto-style3">
                ...
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:TextBox ID="Barangay" runat="server" Width="200px"></asp:TextBox>
                        <br />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" ErrorMessage="Barangay is Required!" ForeColor="Red" ControlToValidate="Barangay"></asp:RequiredFieldValidator>
                    </td>
                    <td class="auto-style3">
                ...
                <tr>
                    <td class="auto-style1">
                        <asp:Button ID="AddSaveButton" runat="server" Text="Add & Save" OnClick="AddSaveButton_Click" />
                    </td>
                    </tr>
            </table>     
        </div>
